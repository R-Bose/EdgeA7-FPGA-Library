...
#
## Push Button
#set_property -dict {PACKAGE_PIN M12 IOSTANDARD LVCMOS33 } [get_ports {digit_en[0]}];
#set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33 } [get_ports {digit_en[1]}];
#set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33 } [get_ports {digit_en[2]}];
#set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33 } [get_ports {rst}];
#set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33 } [get_ports {digit_en[3]}];
set_property -dict {PACKAGE_PIN M12 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {digit_en[0]}];
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {digit_en[1]}];
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {digit_en[2]}];
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {rst}];
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {digit_en[3]}];
#
#
#
## SRAM 512 KB
